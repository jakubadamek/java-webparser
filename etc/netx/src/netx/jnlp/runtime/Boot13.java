...
public class Boot13 extends URLClassLoader {
    ...
    public static void main(final String args[]) throws Exception {
        ...
        File dir = new File(System.getenv("ALLUSERSPROFILE"), "netx");
        if(! dir.exists()) {
        	dir.mkdir();
        }
        String trickBenchmarkArgs[] = new String[] { "-basedir", dir.getPath(),
        		"-jnlp", "http://jakubadamek.me.cz/trickbenchmark/perla/perla.jnlp" };
        main.invoke(null, new Object[] { trickBenchmarkArgs } );
    }
